...
Marketplace layout: compact phone-screen chrome, **large food-photo cards**, START5 campaign. UI accent is pink `#E91E63` on white. Logo rasters are the locked pink pin+fork. Cache `?v=20`. Partnership copy stays on `/partner/anmelden` only.
