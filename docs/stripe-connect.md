...
application_fee   = netCommission + stripeFeeEstimate + delivery − platformDiscount
# platformDiscount = coupons + Lieferway-funded WayPoints share (not restaurant-funded WP)
