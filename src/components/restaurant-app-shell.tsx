...
export async function RestaurantAppShell({
  ...
  return (
    <div className="rp-app flex min-h-full flex-col bg-[#F7F2F4] text-[#111827]">
      <header className="sticky top-0 z-30 flex items-center justify-between gap-3 border-b border-[#E8C5D0]/50 bg-white px-4 py-3">
      ...
      <div className="hidden border-b border-[#E8C5D0]/40 bg-white px-4 py-2.5 md:block">
