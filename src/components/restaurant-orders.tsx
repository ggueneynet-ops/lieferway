  ...
  return (
    <div className={flash ? "lw-kitchen-flash -mx-3 rounded-xl px-3 py-1 md:-mx-5 md:px-5" : ""}>
      ...
      <section className="mb-5">
        ...
        {incoming.length === 0 ? (
          <p className="rounded-2xl border border-[#E8C4CE] bg-white p-4 text-[14px] text-[#6B7280] shadow-[0_6px_18px_rgba(146,42,73,0.06)]">
            {t.noIncoming}
      ...
      <div className="mt-5 grid grid-cols-2 gap-2">
        ...
        <Link
          ...
          className="flex h-14 items-center justify-center rounded-2xl border border-[#E8C4CE] bg-white px-3 text-sm font-semibold text-[#7A2340]"
        >
          {t.rpFinance}
        </Link>
      </div>
