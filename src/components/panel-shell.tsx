...
export async function PanelShell({
  ...
  const NAV: Record<string, { href: string; label: string }[]> = {
    ...
    ADMIN: [
      ...
      { href: "/admin/waypoints", label: t.wpNav },
      { href: "/admin/logs", label: t.adminWebhookLogs },
      { href: "/admin/emails", label: t.adminEmailLogs },
      { href: "/admin/audit", label: t.adminAuditLog },
