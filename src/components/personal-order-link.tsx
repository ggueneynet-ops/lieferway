...
export function PersonalOrderLink({
  ...
  return (
    <section className="rounded-2xl border border-[#922A49]/20 bg-white p-4">
      ...
      <p className="mt-3 break-all rounded-xl bg-[#FAF3EA] px-3 py-2.5 text-[13px] font-medium text-[#7A2340]">
        {url}
      </p>
