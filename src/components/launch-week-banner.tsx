...
export async function LaunchWeekBanner() {
  ...
  return (
    <section className="mt-6 w-full max-w-xl">
      <Link
        href="#restaurants"
        className="group relative block overflow-hidden rounded-[22px] bg-[#FCE4EC] shadow-[0_12px_32px_rgba(233,30,99,0.12)] ring-1 ring-[#F8BBD0] transition hover:shadow-[0_16px_40px_rgba(233,30,99,0.18)]"
      >
