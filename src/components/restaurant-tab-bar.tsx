...
export function RestaurantTabBar({
  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-30 border-t border-[#E8C5D0]/60 bg-white/95 pb-[env(safe-area-inset-bottom)] backdrop-blur-sm">
          ...
          <li key={tab.href}>
            <Link
              ...
              className={`flex flex-col items-center gap-0.5 py-2.5 text-[11px] font-semibold ${
                tab.active ? "text-[#B72E57]" : "text-[#6B7280] hover:text-[#111827]"
              }`}
            >
