  ...
  return (
    <section className="bg-white">
      <div className="lw-wrap py-8 sm:py-10">
        <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-[#922546]">{t.whyLieferway}</p>
        <div className="mt-4 grid gap-3 sm:grid-cols-3 sm:gap-4">
          {cards.map((card) => (
            ...
            >
              <span className="flex size-[3.35rem] shrink-0 items-center justify-center rounded-[18px] bg-[#F7EBEF] text-[#B72E57] sm:size-16 sm:rounded-[20px]">
                <card.icon className="size-7 sm:size-8" strokeWidth={1.75} />
              </span>
              <div className="min-w-0">
                <p className="text-[12px] font-semibold text-[#B72E57]">{card.short}</p>
