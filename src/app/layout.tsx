...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: "/icon-pin-fork.svg?v=32", type: "image/svg+xml" },
      { url: "/favicon.svg?v=32", type: "image/svg+xml" },
      { url: "/favicon-32.png?v=32", sizes: "32x32", type: "image/png" },
      { url: "/favicon-64.png?v=32", sizes: "64x64", type: "image/png" },
    ],
    apple: "/apple-touch-icon.png?v=32",
  },
};
